...
import { MESSAGE_TYPE, RESPONSE_TYPE, FGCLITE_ACCOUNT_CHANGE } from '../../constants';
...
export default class SessionController extends IController {
  ...
  */
  public clearSession = () => {
    ...
    this.main.inpageAccount.sendInpageAccountAllPorts(FGCLITE_ACCOUNT_CHANGE.LOGOUT);
  }
