...
class Receive extends Component<WithStyles & IProps, {}> {
  public render() {
    ...
    const { loggedInAccountName, info, fantasygoldBalanceUSD, networkBalAnnotation } = this.props.store.sessionStore;
      ...
      <div className={classes.root}>
        ...
        <div className={classes.contentContainer}>
          ...
          <div className={classes.amountContainer}>
            ...
            <Typography className={classes.token}>FGC</Typography>
          </div>
          <Typography className={classes.currencyValue}>{`${fantasygoldBalanceUSD} ${networkBalAnnotation}`}</Typography>
          <div className={classes.qrCodeContainer}>
            <FGCode value={info!.addrStr} />
          </div>
        </div>
      </div>
    );
