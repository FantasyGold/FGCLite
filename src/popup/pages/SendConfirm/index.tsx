      ...
      <div className={classes.root}>
        ...
        <div className={classes.contentContainer}>
          <div className={classes.inputContainer}>
            ...
            {this.props.store.sendStore.token && this.props.store.sendStore.token.symbol === 'FGC' ? (
              ...
              <div>
                ...
                <CostField fieldName={'Max Transaction Fee'} amount={maxTxFee} unit={'FGC'} {...this.props} />
              </div>
            )}
          </div>
